...
(function() {
    ...
    var link = function(str, options) {
        var $element = $('<a>', {
            ...
            markup = ElementUtils.getOuterMarkup($element);
        return markup;
    };
...
fabric.Object.prototype.getRatio = function() {
    var ratio = this.get('width') / this.get('height');
    return ratio;
};
...
fabric.Object.prototype.getRelativeHeight = function() {
    var height = this.getHeight() / this.canvas.getHeight();
    return height;
};
...
fabric.Object.prototype.getRelativeLeft = function() {
    var left = this.getLeft() / this.canvas.getWidth();
    return left;
};
...
fabric.Object.prototype.getRelativeTop = function() {
    var top = this.getTop() / this.canvas.getHeight();
    return top;
};
...
fabric.Object.prototype.getRelativeWidth = function() {
    var width = this.getWidth() / this.canvas.getWidth();
    return width;
};
    ...
    var snap = function(obj) {
        ...
        if (ArrayUtils.contains(corner, exemptCorners) === false) {
            ...
            if (
                ...
                // Trigger the event so the BaseDrawing can receive it
...
fabric.util.object.extend(fabric.Object.prototype, {
  ...
  drawBorders: function(ctx) {
    ...
    ctx.strokeStyle = this.stencilBorderColorDark;
    ...
    ctx.strokeStyle = this.stencilBorderColorLight;
    // ctx.setLineDash([1,3]);
    ctx.setLineDash([3,3]);
    ...
    if (this.hasRotatingPoint && this.isControlVisible('mtr') && !this.get('lockRotation') && this.hasControls) {
      ...
      ctx.strokeStyle = this.stencilRotatingPointColorDark;
      ctx.setLineDash([1]);
      ctx.beginPath();
      ...
      ctx.strokeStyle = this.stencilRotatingPointColorLight;
      // ctx.setLineDash([1,2]);
      ctx.setLineDash([1,3]);
      ctx.beginPath();
      ctx.moveTo(0, rotateHeight);
...
(function() {
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    ...
    _drawControl: function(control, ctx, methodName, left, top) {
      ...
      ctx.fill();
      if (control === 'mtr') {
        var image = DataStorageUtils.get('rotateIconImageReference');
        if (image !== undefined) {
 ...
 * 
 * Not currently being used, but was intended for use by the
...
Function.prototype.delay = function(milliseconds, context, args) {
    milliseconds = ValidationUtils.getDefaultValue(milliseconds, 0);
    milliseconds = milliseconds.toInt();
    context = ValidationUtils.getDefaultValue(context, window);
    args = ValidationUtils.getDefaultValue(args, []);
...
jQuery.fn.scrollTo = function(to, duration, callback) {
    duration = ValidationUtils.getDefaultValue(duration, 1000);
    callback = ValidationUtils.getDefaultValue(callback, function() {});
    $(this).animate(
        {
...
window.XHRPool = (function() {
    ...
    /**
     * __addStencilCustomDataToXHRObject
     * 
     * @access  private
     * @param   Object jqXHR
     * @param   Object options
     * @return  void
     */
    var __addStencilCustomDataToXHRObject = function(jqXHR, options) {
        var stencilCustomData = {};
        stencilCustomData.url = options.url;
        jqXHR.stencilCustomData = stencilCustomData;
    };
    ...
    return {
        ...
        init: function() {
            $(document).ajaxSend(function(event, jqXHR, options) {
                __addStencilCustomDataToXHRObject(jqXHR, options);
                XHRPool.add(jqXHR);
            });
        ...
        abortAll: function() {
            ...
            for (index in requests) {
                ...
                if (__abortEvaluator === null) {
                    request.abort();
                    continue;
                }
                var response = __abortEvaluator(request);
                if (response === true) {
                    request.abort();
                    continue;
                }
         ...
         * @return  void
         */
        setAbortEvaluator: function(evaluator) {
            __abortEvaluator = evaluator;
        }
    };
})();
